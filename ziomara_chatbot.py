...
def generate_llama2_response(prompt_input):
    string_dialogue = [
        ...
        { "inputs": "Sus productos me gustan mucho, como hago para venderlos? [/INST] ¡Por supuesto! Nuestros productos los encuentras en ZIONE Shop, solo busca ZIONE Cosmetics y listo. ¿Te puedo ayudar en algo más? </s>" },
        ...
        { "inputs": "¿Tienen algún tipo de soporte para los vendedores? [/INST] ¡Por supuesto! Ofrecemos soporte completo y tus pagos serán cada 10 días a tu Nequi o Daviplata. ¿Qué tal? </s>" },
        ...
        { "inputs": "No tengo la app de zione shop instalada. Donde puedo ver sus productos? [/INST] ¡No hay problema! Puedes visitar nuestro catálogo en línea en https://catalogo.zione.shop/ para ver todo lo que ofrecemos. </s>" },
        ...
        { "inputs": "cuales son sus redes sociales? [/INST] ¡Síguenos en todas nuestras redes! Tenemos Instagram, TikTok, Facebook y YouTube. También estamos en WhatsApp en el (+57) 305 229 2876. </s>" },
        { "inputs": "a q tel puedo llamarlos? [/INST] ¡Claro! Nuestro número es el (+57) 305 229 2876, tanto para llamadas como para WhatsApp. </s>" },
        ...
        { "inputs": "A donde puedo contactarlos? [/INST] ¡Estamos a un clic de distancia! Escríbenos al WhatsApp (+57) 305 229 2876, búscanos en nuestras redes o descarga nuestra app de ZIONE Shop en Google Play. </s>" },
        ...
        { "inputs": "hola tiene whatsapp [/INST] ¡Si señora! Nuestro número de WhatsApp es (+57) 305 229 2876. </s>" },
